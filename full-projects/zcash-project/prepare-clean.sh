...
cat zcash.txt zips.txt zcash-docs.txt librustzcash.txt gitian.sigs.txt mpc.txt zcash-gitian.txt logos.txt zfaucet.txt libsnark.txt | sort -n > zcash-project.txt
