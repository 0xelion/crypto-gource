...
git clone https://github.com/iotaledger/libopencl-stub
...
gource --output-custom-log libopencl-stub.txt libopencl-stub
...
sed -i -r "s#(.+)\|#\1|/libopencl-stub#" libopencl-stub.txt
